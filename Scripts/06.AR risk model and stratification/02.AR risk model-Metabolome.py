...
df = pd.read_csv("Target_metabolome.csv")
...
plt.tight_layout()
plt.savefig("ROC_curve_metabolome.pdf", format="pdf", bbox_inches="tight")
plt.show()
...
feature_importance.to_csv("Shap_feature_importance_metabolome.csv", index=False)