...
df = pd.read_csv("Target_microbiome.csv")
...
plt.tight_layout()
plt.savefig("ROC_curve_microbiome.pdf", format="pdf", bbox_inches="tight")
plt.show()
...
feature_importance.to_csv("Shap_feature_importance_microbiome.csv", index=False)