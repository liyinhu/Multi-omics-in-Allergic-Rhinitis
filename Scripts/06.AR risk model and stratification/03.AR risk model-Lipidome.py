...
df = pd.read_csv("Target_Lipidome.csv")
...
plt.tight_layout()
plt.savefig("ROC_curve_lipidome.pdf", format="pdf", bbox_inches="tight")
plt.show()
...
feature_importance.to_csv("Shap_feature_importance_lipidome.csv", index=False)